...
So, let's start with Siril. You can find it's download page [here](https://siril.org/download/). For this guide, I'll be talking about Siril 1.4.0, which is the latest version as of this writing. I'll try to keep up with any major changes as they come. Select the version for your operating system, and download then install. 
